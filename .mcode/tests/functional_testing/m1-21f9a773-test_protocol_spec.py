...
Generated at: 2026-03-04T19:23:20.240532+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Add two positive numbers and verify result is 8.0",
        "setup": null,
        "cleanup": null
    },
    {
        ...
        "expected_status": 200,
        "description": "Add two negative numbers and verify result is -14.0",
        "setup": null,
        "cleanup": null
    },
    {
    ...
    },
    {
        ...
        "expected_status": 422,
        "description": "Send string instead of number for field a, expect validation error",
        "setup": null,
        "cleanup": null
    },
    {
        ...
        "expected_status": 200,
        "description": "Subtract 4 from 10 and verify result is 6.0",
        "setup": null,
        "cleanup": null
    },
    {
        "name": "subtract_result_negative",
        "category": "BOUNDARY",
        "endpoint": "/subtract",
        "method": "POST",
        "request_data": {
        ...
        "expected_status": 200,
        "description": "Subtract larger from smaller number, verify negative result -4.0",
        "setup": null,
        "cleanup": null
    },
    {
        "name": "subtract_missing_field",
        "category": "MISSING_REQUIRED",
        "endpoint": "/subtract",
        "method": "POST",
        "request_data": {
        ...
        "expected_status": 422,
        "description": "Send request with missing required field a, expect validation error",
        "setup": null,
        "cleanup": null
    },
    {
        ...
        "expected_status": 200,
        "description": "Multiply 7 by 6 and verify result is 42.0",
        "setup": null,
        "cleanup": null
    },
    {
        ...
        "expected_status": 200,
        "description": "Multiply by zero and verify result is 0.0",
        "setup": null,
        "cleanup": null
    },
    {
        ...
        "expected_status": 422,
        "description": "Send boolean instead of number for field b, expect validation error",
        "setup": null,
        "cleanup": null
    },
    {
        ...
        "expected_status": 200,
        "description": "Divide 10 by 4 and verify result is 2.5",
        "setup": null,
        "cleanup": null
    },
    {
        ...
        "expected_status": 400,
        "description": "Divide by zero and verify HTTP 400 with detail 'Cannot divide by zero'",
        "setup": null,
        "cleanup": null
    },
    {
        "name": "divide_negative_numbers",
        "category": "HAPPY_PATH",
        "endpoint": "/divide",
        "method": "POST",
        "request_data": {
        ...
        "expected_status": 200,
        "description": "Divide negative by positive and verify result is -5.0",
        "setup": null,
        "cleanup": null
    },
    {
