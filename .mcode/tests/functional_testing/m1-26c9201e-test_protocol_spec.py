...
Generated at: 2026-03-05T19:34:47.497937+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Add 5 + 3, expect result 8.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": 8.0
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Add two negative floats, expect result -14.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": -14.0
    ...
    },
    {
        ...
        "expected_status": 422,
        "description": "Omit required field b, expect 422 validation error",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "detail": [
    ...
    },
    {
        ...
        "expected_status": 422,
        "description": "Send string instead of number for a, expect 422 validation error",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "detail": [
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Subtract 10 - 4, expect result 6.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": 6.0
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Subtract where result is negative: 3 - 10 = -7.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": -7.0
    ...
    },
    {
        ...
        "expected_status": 422,
        "description": "Omit required field a, expect 422 validation error",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "detail": [
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Multiply 7 * 6, expect result 42.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": 42.0
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Multiply by zero: 99 * 0 = 0.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": 0.0
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Divide 10 / 4, expect result 2.5",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": 2.5
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Divide negative by positive: -15 / 3 = -5.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": -5.0
    ...
    },
    {
        ...
        "expected_status": 422,
        "description": "Omit both required fields a and b, expect 422 validation error",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "detail": [
