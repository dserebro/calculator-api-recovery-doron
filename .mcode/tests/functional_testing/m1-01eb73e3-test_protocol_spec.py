...
Generated at: 2026-03-10T06:23:56.266842+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Add two positive numbers and verify result is 13.7",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": 13.7
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Add two negative numbers and verify result is -8.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": -8.0
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Subtract 7.5 from 20.0 and verify result is 12.5",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": 12.5
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Subtract larger number from smaller, verify negative result -7.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": -7.0
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Multiply 4.0 by 5.5 and verify result is 22.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": 22.0
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Divide 20.0 by 4.0 and verify result is 5.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": 5.0
    ...
    },
    {
        ...
        "expected_status": 400,
        "description": "Divide by zero, expect 400 with detail 'Cannot divide by zero'",
        "setup": null,
        "cleanup": null,
        "actual_response": {
