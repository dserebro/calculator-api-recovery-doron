...
Generated at: 2026-03-05T04:19:40.954134+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Add 5 and 3, expect result 8.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": 8.0
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Add two negative numbers, expect result -14.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": -14.0
    ...
    },
    {
        ...
        "expected_status": 422,
        "description": "Send only field a without b, expect validation error",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "detail": [
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Subtract 4 from 10, expect result 6.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": 6.0
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Subtract 7 from 3, expect negative result -4.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": -4.0
    ...
    },
    {
        ...
        "expected_status": 422,
        "description": "Send only field b without a, expect validation error",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "detail": [
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Multiply 6 by 7, expect result 42.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": 42.0
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Multiply by zero, expect result 0.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": 0.0
    ...
    },
    {
        ...
        "expected_status": 422,
        "description": "Send empty body, expect validation error for missing a and b",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "detail": [
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Divide 20 by 4, expect result 5.0",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": 5.0
    ...
    },
    {
        ...
        "expected_status": 400,
        "description": "Divide by zero, expect HTTP 400 with detail 'Cannot divide by zero'",
        "setup": null,
        "cleanup": null,
        "actual_response": {
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "Divide 7 by 2, expect fractional result 3.5",
        "setup": null,
        "cleanup": null,
        "actual_response": {
            "result": 3.5
