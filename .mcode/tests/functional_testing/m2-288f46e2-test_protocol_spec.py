...
Generated at: 2026-03-04T19:22:31.484115+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "method": "POST",
        "description": "Create a new calculation with a valid add operation and verify the response contains the computed result",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a calculation with an invalid operation name, expecting a 400 error",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Attempt to create a division calculation with b=0, expecting a 400 error for division by zero",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "create_calculation_mul_operation",
        "category": "HAPPY_PATH",
        "endpoint": "/calculations",
        "method": "POST",
        "description": "Create a multiplication calculation and verify correct result is returned",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/calculations",
        "method": "GET",
        "description": "Create a calculation, then list all calculations and verify the response is an array",
        "setup": {
            "endpoint": "/calculations",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "GET",
        "description": "Attempt to retrieve a calculation with a non-existent ID, expecting 404",
        "setup": null,
        "request_data": {
            "path": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Create a calculation, then delete it and verify 204 No Content response",
        "setup": {
            "endpoint": "/calculations",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/calculations/{calculation_id}",
        "method": "DELETE",
        "description": "Attempt to delete a calculation with a non-existent ID, expecting 404",
        "setup": null,
        "request_data": {
            "path": {
                "calculation_id": 999999
